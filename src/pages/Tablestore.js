        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-2">
                    <br /><br /><br /><br />
                    <img
                        src="https://nhacaiuytinvip.com/wp-content/uploads/2022/02/banner-fb88-sidebar-2.gif"
                    ></img>
                    <img
                        src="https://nhacaiuytinvip.com/wp-content/uploads/2022/06/WY88-Web-Web-Banner-Design-300x300-1.gif"
                    ></img>
                    <img
                        src="https://nhacaiuytinvip.com/wp-content/uploads/2022/07/dai-ly-w88.gif"
                    ></img>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="container">
                        <center>
                            <br />
                            <h2 style={{ padding: 20 }}>Tìm theo thành phố</h2>
                        </center>
                        <div class="row">
                            {' '}
                                    ...
                                    {nameStore != null ? (
                                        ...
                                        >
                                            ...
                                            {nameStore.map((item, key) => (
                                                <option value={key}>{item.city_province}</option>
                                            ))}
                                        </select>
                                    ) : (
                                        ''
                        ...
                        <form action="https://62c789832b03e73a58e63864.mockapi.io/feedback" method="POST">
                                    ...
                                    <td>
                                        {saveNameStore && (
                                            <div>
                                                <center>
                                                    {' '}
                                                    <p>{saveNameStore.city_province}</p>
                                                </center>
                                            </div>
                                        )}
                                    </td>
