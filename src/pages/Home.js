      ...
      <div className="container">
        <div className="box1 row">
          <div className="img-hover-zoom col-xl-6 col-lg-6 col-md-6" border="1px" solid="#ddd">
            ...
            <Link to='/' type="button" className="btn btn-primary">Xem thêm</Link>
          </div>
            ...
            <div className="container">
              <div className="box1 row">
                ...
                <div className="img-hover-zoom col-xl-6 col-lg-6 col-md-6" border="1px" solid="#ddd" s>
                  ...
                  <br />
                  <br />
                  <a href='http://icdn.dantri.com.vn/zoom/1200_630/2019/12/13/bai-thi-1576206748782.jpg' type="button" className="btn btn-primary">Xem thêm</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="container">
              <div className="box1 row">
                ...
                <div className="img-hover-zoom col-xl-6 col-lg-6 col-md-6" border="1px" solid="#ddd">
                  ...
                  <br />
                  <br />
                  <a href='https://ducdongbaolong.vn/wp-content/uploads/2018/05/lu-huong-dat-vang.jpg' type="button" className="btn btn-primary">Xem thêm</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="container">
              <div className="box1 row">
                ...
                <div className="img-hover-zoom col-xl-6 col-lg-6 col-md-6" border="1px" solid="#ddd">
                  ...
                  <br />
                  <br />
                  <a href='https://nld.mediacdn.vn/291774122806476800/2021/12/19/phanquocviet-1639909959011639280845-16399100210371218288978.jpg' type="button" className="btn btn-primary">Xem thêm</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="container">
              <div className="box1 row">
                ...
                <div className="img-hover-zoom col-xl-6 col-lg-6 col-md-6" border="1px" solid="#ddd">
                  ...
                  <br />
                  <br />
                  <a href='http://image.congan.com.vn/thumbnail/CATP-480-2021-12-4/7a-1_434_260_335.png' type="button" className="btn btn-primary">Xem thêm</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="container">
              <div className="box1 row">
                ...
                <div className="img-hover-zoom col-xl-6 col-lg-6 col-md-6" border="1px" solid="#ddd">
                  ...
                  <br />
                  <br />
                  <a href='https://media-cdn-v2.laodong.vn/Storage/NewsPortal/2021/9/8/951318/Phan-Anh-1.jpg' type="button" className="btn btn-primary">Xem thêm</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="container">
              <div className="box1 row">
                ...
                <div className="img-hover-zoom col-xl-6 col-lg-6 col-md-6" border="1px" solid="#ddd">
                  ...
                  <br />
                  <br />
                  <a href='https://vnn-imgs-f.vgcloud.vn/2018/07/04/09/ca-do.jpg' type="button" className="btn btn-primary">Xem thêm</a>
                </div>
              </div>
            </div>
          </div>
