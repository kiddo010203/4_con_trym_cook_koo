            ...
            <div style={{ "background-color": "#000", "color": "white" }}>
                <div className="container">
                    <div className='row'>
                        ...
                        <div className="col-md-2 col-sm-6">
                            <li className="menu-item">MUA XE</li>
                        ...
                        <div className="col-md-2 col-sm-6">
                            <li className="menu-item">SOCIAL MEDIA</li>
                            ...
                            <li className="menu-item"> <i class="fa-brands fa-facebook"></i></li>
                        </div>
                    </div>
                </div>
            </div>
            <div style={{ "background-color": "#000", "color": "white" }}></div>
